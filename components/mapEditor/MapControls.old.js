      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        ...
        <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
          <button
            style={{
              padding: '8px 12px',
              background: isExecuting ? '#ffebee' : '#e8f5e9',
              border: `1px solid ${isExecuting ? '#ef9a9a' : '#a5d6a7'}`,
              borderRadius: '4px',
              cursor: 'pointer',
              display: 'flex',
              alignItems: 'center',
          ...
          >
            <span style={{ marginRight: '5px' }}>{isExecuting ? '⏹️' : '▶️'}</span>
          ...
          >
            <span style={{ marginRight: '5px' }}>🔄</span> Reset
          </button>
          <button
            style={{
              padding: '8px 12px',
          ...
          >
            <span style={{ marginRight: '5px' }}>⏭️</span> Step
          </button>
        </div>

        {/* Execution Speed Control */}
        <div style={{ display: 'flex', gap: '10px', marginBottom: '10px', alignItems: 'center' }}>
          <label style={{ fontSize: '14px', minWidth: '80px' }}>Speed:</label>
          <input
            type="range"
            min="100"
            max="3000"
            ...
            style={{ flex: 1 }}
          />
          <span style={{ fontSize: '12px', minWidth: '60px' }}>{executionSpeed}ms</span>
        </div>
